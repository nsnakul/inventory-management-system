...
$sql="INSERT INTO item_master(Item_name,Rate,status)VALUES('$name','$rate','1')";
...
<tr>
<td style=color:goldenrod;font-size:20;font-weight:bold>RATE:</td><td><input type=text name='t2'></td></tr>
