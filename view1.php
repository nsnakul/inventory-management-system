...
echo'<tr style=color:red;background-color:#ffab40><th style=text-transform:uppercase>SL NO. </th><th style=text-transform:uppercase>ITEM NAME</th><th style=text-transform:uppercase>RATE</th></tr>';
...
echo'<tr><td>'. $Id. '</td><td>' .$Item_name. '</td><td>' .$rt. '</td></tr>';
}
echo '</table>';
}
else
...
<tr>
<br/><td style=color:red;font-size:25>ENTER PRODUCT USER ID:-</td>
</tr>
<td><input type=text name=t1 style="height:28;width:300;margin-left:5%"></td>

 
<tr>
<td>
<input type="submit" name="view" value="view" style="font-size:25;font-weight:bold;color:sky;background-color:pink;height:35;width:200;margin-left:20%">
</td>
</tr>
