...
<th style=text-align:center;text-trnsform:uppercase>PURCHASE DETAIL ID</th>
...
$sts=$r['status'];
echo'<tr>
       <td style=text-align:center;text-trnsform:uppercase>'.$tid.'</td> 
	  ...
	  <td style=text-align:center;text-trnsform:uppercase>'.$sn.'</td>
