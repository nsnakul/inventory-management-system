...
$conn = mysqli_connect($servername, $username, $password,$dbname);
  ...
  $sql= ' select *from salemaster where status=1';
...
<th style=text-align:center;text-trnsform:uppercase>TRANSFER NO.</th> 
<th style=text-align:center;text-trnsform:uppercase>TRANSFER DATE</th>
<th style=text-align:center;text-trnsform:uppercase>CUSTOMER NAME</th>  
...
echo'<tr>
	  ...
	  <td style=text-align:center;text-trnsform:uppercase>'.$tn.'</td>
	  <td style=text-align:center;text-trnsform:uppercase>'.$td.'</td>
	  <td style=text-align:center;text-trnsform:uppercase>'.$cmn.'</td>
